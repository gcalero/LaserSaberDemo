...
#ifndef LASER_SABER_APP_SRC_MAIN_JNI_APP_JNI_H_  // NOLINT
#define LASER_SABER_APP_SRC_MAIN_JNI_APP_JNI_H_
...
#define NATIVE_METHOD(return_type, method_name) \
  JNIEXPORT return_type JNICALL                 \
      Java_gcalero_demo_lasersabervr_MainActivity_##method_name
...
#endif  // LASER_SABER_APP_SRC_MAIN_JNI_APP_JNI_H_  // NOLINT
